...
<head>
	...
	<link rel="shortcut icon" href="<?= BASEURL ?>assets/img/logo/sapi.jpg">

</head>

<body>
	<header class="navbar navbar-expand-md navbar-dark fixed-top bg-white border-bottom shadow-sm">
		<h5 class="p-2 font-weight-normal"><a href="<?= BASEURL ?>" class="nav-link">SAPIKU</a></h5>
		...
		<div class="collapse navbar-collapse" id="navbars">
			<form id="cari" action="<?= BASEURL ?>kategori/cari" class="input-group p-2" method="POST">
				<input type="text" name="cari" class="form-control" autocomplete="off" placeholder="Cari sapi" aria-label="cari" aria-describedby="cari" required>
				<div class="input-group-append">
					<button class="btn btn-outline-secondary" type="submit" id="cari">Cari</button>
				</div>
			</form>
			<a class="btn btn-outline-secondary" href="<?= BASEURL ?>home" role="button" aria-haspopup="true" aria-expanded="false" style="color:black">Home</a>
			<ul class="nav nav-pills navbar-nav p-2">
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right mt-3" aria-labelledby="kategori">
						<a class="dropdown-item" href="<?= BASEURL ?>kategori/simental">Simental</a>
						<a class="dropdown-item" href="<?= BASEURL ?>kategori/limosin">Limosin</a>
						<a class="dropdown-item" href="<?= BASEURL ?>kategori/madura">Madura</a>
					</div>
				</li>
			</ul>
			<?php Flasher::header() ?>
