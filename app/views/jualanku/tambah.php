<div class="container">
    <div class="card">
        ...
        <ul class="list-group list-group-flush">
            <form action="<?= BASEURL ?>jualanku/tambahJualanku" enctype="multipart/form-data" method="post">
                <li class="list-group-item">

                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="nama">Nama jualanku</label>
                            <input type="text" class="form-control" name="nama" placeholder="Nama jualanku" required>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" name="stok" placeholder="jumlah" required>
                        </div>
                    </div>
                    <div>
                        <label> Foto </label>
